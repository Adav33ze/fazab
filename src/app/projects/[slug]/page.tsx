    ...
    <>
      <Section aria-labelledby="project-heading">
        <Container size="lg" className="flex flex-col gap-section-mobile lg:gap-section-desktop">
          <Link
            href="/projects"
            className="font-mono text-caption uppercase tracking-[0.2em] text-foreground-muted transition-colors duration-200 hover:text-accent"
          >
            ← All projects
          </Link>
          ...
          <div className="grid grid-cols-1 gap-block lg:grid-cols-12 lg:gap-x-8">
            ...
            <dl className="flex flex-col gap-6 border-t border-border pt-6 lg:col-span-3 lg:col-start-10">
              <div>
      ...
      <Section aria-labelledby="overview-heading">
        <Container size="md">
          ...
          <p className="mt-8 font-display text-h2 font-medium leading-snug text-foreground lg:text-h1">
            {project.description}
          </p>
        </Container>
      </Section>
